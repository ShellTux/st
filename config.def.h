...
static char *font2[] = {
	...
	"JoyPixels:style=Regular:pixelsize=20:antialias=true:hinting=true",
	"Font Awesome 6 Free:style=Solid:pixelsize=20:antialias=true:hinting=true",
	"Font Awesome 6 Free:style=Regular:pixelsize=20:antialias=true:hinting=true",
	"Font Awesome 6 Brands:style=Regular:pixelsize=20:antialias=true:hinting=true"
